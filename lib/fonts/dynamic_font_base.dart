...
import 'dynamic_fonts_descriptor.dart';
...
TextStyle dynamicFontsTextStyle({
  ...
  @required Map<DynamicFontsVariant, DynamicFontsFile> fonts,
}) {
...
/// the [FontLoader].
Future<void> loadFontIfNecessary(DynamicFontsDescriptor descriptor) async {
...
/// Returns [DynamicFontsVariant] from [variantsToCompare] that most closely
...
DynamicFontsVariant _closestMatch(
  DynamicFontsVariant sourceVariant,
  Iterable<DynamicFontsVariant> variantsToCompare,
) {
  int bestScore;
  DynamicFontsVariant bestMatch;
...
int _computeMatch(DynamicFontsVariant a, DynamicFontsVariant b) {
  if (a == b) {
    return 0;
  }
