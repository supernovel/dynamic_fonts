...
class DynamicFontsVariant {
  ...
  /// Creates a [DynamicFontsVariant] from a Google Fonts API specific
  /// filename part.
  ///
  ...
  ///
  /// See [DynamicFontsVariant.toApiFilenamePart] for the inverse function.
  DynamicFontsVariant.fromApiFilenamePart(String filenamePart)
  ...
  ///
  /// See [DynamicFontsVariant.toString] for the inverse function.
  DynamicFontsVariant.fromString(String variantString)
  ...
  /// Converts this [DynamicFontsVariant] to a Google Fonts API specific filename
  /// part.
  ///
  /// A Filename part is the part of the filename that does not include the
  /// font family. For example: for the filename "Lato-Regular.ttf", the
  /// filename part is "Regular".
  ///
  /// The following table shows how these [DynamicFontsVariant]s convert:
  ...
  ///
  /// See [DynamicFontsVariant.fromApiFilenamePart] for the inverse function.
  ...
  /// Converts this [DynamicFontsVariant] to a Google Fonts API specific variant
  /// name string.
  ///
  /// The following table shows how these variant strings convert:
  /// weight: 400, style: normal -> 'regular'
